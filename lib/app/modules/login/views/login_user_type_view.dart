...
class LoginUserViewType extends GetView<LoginController> {
  const LoginUserViewType({Key? key}) : super(key: key);
              ...
              ElevatedButton(
                  ...
                  onPressed: () {
                    Get.toNamed(Routes.LOGIN,
                        arguments: LoginUserType.Institute);
                  },
                  child: Text("Institute Login", style: buttonStyle)),
              SizedBox(
                height: 15,
              ),
              ElevatedButton(
                  ...
                  onPressed: () {
                    Get.toNamed(Routes.LOGIN,
                        arguments: LoginUserType.Volunteer);
                  },
                  child: Text("Volunteer Login", style: buttonStyle)),
              SizedBox(
                height: 15,
              ),
              ElevatedButton(
                  style: ElevatedButton.styleFrom(
                      ...
                      minimumSize: Size(width * 0.7, 46)),
                  onPressed: () {
                    Get.toNamed(Routes.LOGIN, arguments: LoginUserType.NDRF);
                  },
                  child: Text(
                    "NDRF Login",
                    style: buttonStyle,
